...
{
    [TestClass]
    public class NoStaleSerialize
    {
        [TestMethod]
        public void TestNoStaleSerialze()
        {
            // Set up the mocks
            ...
            // Clear the cache again and then call from multiple threads. Only
            // one thread should make the call to the cache refresher
            fakeCacheData.Clear();
